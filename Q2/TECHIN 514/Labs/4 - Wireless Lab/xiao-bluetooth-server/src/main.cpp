...
#define SERVICE_UUID        "49c416b3-e63f-4c86-963f-0f7f39f8cd17"
#define CHARACTERISTIC_UUID "9c97aa44-312c-4488-8fa4-3f86a87f6c0e"
...
void setup() {
    Serial.begin(115200);
    Serial.println("Setup started");  // Added for debugging
