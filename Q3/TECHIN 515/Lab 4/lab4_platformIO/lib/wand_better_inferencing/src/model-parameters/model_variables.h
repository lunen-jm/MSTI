...
const char* ei_classifier_inferencing_categories[] = { "begin", "fire", "heal", "shield" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_2_axes[] = { 0, 1, 2, 3, 4, 5 };
const uint32_t ei_dsp_config_2_axes_size = 6;
ei_dsp_config_spectral_analysis_t ei_dsp_config_2 = {
    2, // uint32_t blockId
    4, // int implementationVersion
    6, // int length of axes
    0.02472187839651f, // float scale-axes
    1, // int input-decimation-ratio
    "low", // select filter-type
    18.0f, // float filter-cutoff
    8, // int filter-order
...
const ei_impulse_t impulse_701153_0 = {
    .project_id = 701153,
    .project_owner = "lunen-jm",
    .project_name = "wand_better",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_701153_0 = ei_impulse_handle_t( &impulse_701153_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_701153_0;
